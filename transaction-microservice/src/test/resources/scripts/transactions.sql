...
insert into transaction (id, type, method, amount, date, account_id, initial_balance, posted_balance, status, merchant_code, initialized)
values (1, 'WITHDRAWAL', 'ACH', 10000, '2021-08-01', 1, 100000, 90000, 'APPROVED', 'ALNE', 1);

insert into transaction (id, type, method, amount, date, account_id, initial_balance, posted_balance, status, merchant_code, initialized)
values (2, 'PURCHASE', 'DEBIT_CARD', 10000, '2021-08-01', 1, 90000, 80000, 'APPROVED', 'ALNE', 1);

insert into transaction (id, type, method, amount, date, account_id, initial_balance, posted_balance, status, merchant_code, initialized)
values (3, 'PURCHASE', 'DEBIT_CARD', 10000, '2021-08-01', 3, 50000, 80000, 'APPROVED', 'ALNE', 1);

insert into transaction (id, type, method, amount, date, account_id, initial_balance, posted_balance, status, merchant_code, initialized)
values (4, 'DEPOSIT', 'ACH', 500000, '2021-08-01', 3, 1300000, 80000, 'APPROVED', 'ALNE', 1);

insert into transaction (id, type, method, amount, date, account_id, initial_balance, posted_balance, status, merchant_code, initialized)
values (5, 'DEPOSIT', 'ACH', 500000, '2021-08-01', 1, 1300000, 80000, 'APPROVED', 'ALNE', 1);

insert into transaction (id, type, method, amount, date, account_id, initial_balance, posted_balance, status, merchant_code, initialized)
values (6, 'WITHDRAWAL', 'ACH', 500000, '2021-08-01', 3, 1800000, 1300000, 'APPROVED', 'ALNE', 1);

insert into transaction (id, type, method, amount, date, account_id, initial_balance, posted_balance, status, merchant_code, initialized)
values (7, 'TRANSFER_OUT', 'APP', 500000, '2021-08-01', 2, 1300000, 80000, 'APPROVED', 'ALNE', 1);
